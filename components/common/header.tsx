    ...
    <div className="hidden flex-col md:flex">
        <div className="border-b">
            ...
            <nav className={cn("flex items-center space-x-4 lg:space-x-6 mx-6")}>
                ...
                <Link href='/property' className="text-sm font-medium transition-colors hover:text-primary">Properties</Link>
                <Link href='/tenants' className="text-sm font-medium transition-colors hover:text-primary">Tenants</Link>
